...
// CONCATENATED MODULE: ./node_modules/xy-form/es/FormRestButton.js


/**
 * 重置按钮
 */
function FormRestButton(_a) {
    ...
    return react_default.a.cloneElement(children, { onClick: clickHande });
}
//# sourceMappingURL=FormRestButton.js.map
// CONCATENATED MODULE: ./site/pages/Form/Form/Methods.tsx




function FormMethodsDemo(_a) {
    var history = _a.history;
    var formMethodsRef = Object(react["useRef"])(null);
    function setAll() {
    ...
    function getName() {
        Toast["a" /* default */].info("姓名为: " + formMethodsRef.current.getFieldValue("name"));
    }
    return (react_default.a.createElement(Form["a" /* default */], { title: "\u8868\u5355\u6807\u9898", desc: "\u8868\u5355\u8BF4\u660E", getFormMethods: function (methods) { return (formMethodsRef.current = methods); }, opr: react_default.a.createElement(react_default.a.Fragment, null,
            react_default.a.createElement(FormRestButton, null,
                react_default.a.createElement(Button["a" /* default */], { type: "primary" }, "\u91CD \u7F6E")),
            react_default.a.createElement(Button["a" /* default */], { onClick: setAll }, "\u8BBE\u7F6E\u6574\u4E2A\u6A21\u578B"),
            react_default.a.createElement(Button["a" /* default */], { onClick: setName }, "\u8BBE\u7F6E\u5355\u4E2A\u503C"),
            react_default.a.createElement(Button["a" /* default */], { onClick: getName }, "\u83B7\u53D6\u5355\u4E2A\u503C"),
...
/* harmony default export */ var Methods = __webpack_exports__["default"] = (Object(react_router["f" /* withRouter */])(FormMethodsDemo));
